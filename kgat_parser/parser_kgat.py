...
def parse_kgat_args():
    ...
    parser.add_argument('--data_name', nargs='?', default='last-fm',
                        help='Choose a dataset from {yelp2018, last-fm, amazon-book,facebook}')

    parser.add_argument('--data_dir', nargs='?', default='G:/5P30/FinalProject/KGAT-pytorch-master/datasets',
    ...
    parser.add_argument('--cf_batch_size', type=int, default=512,
                        help='CF batch size.')
